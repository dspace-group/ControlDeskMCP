...
All orchestration is delegated to controldesk_mcp.services.measurement_service.
"""
...
from controldesk_mcp.services import measurement_service
...
async def recording_manage(params: RecordingManageInput) -> object:
    if params.action == RecordingManageAction.list_recordings:
        ...
        if isinstance(result, ErrorEnvelope):
            return result
        from controldesk_mcp.models.measurement import MeasurementListRecordingsResult
