...
from controldesk_mcp.com_bridge.error_handling.circuit_breaker import CircuitBreaker, get_breaker
from controldesk_mcp.com_bridge.error_handling.hresult import map_com_error
from controldesk_mcp.com_bridge.errors import BridgeError, BridgeTimeoutError
...
async def guarded_dispatch(
    ...
    *args: Any,
    ...
    """
    import controldesk_mcp.com_bridge as _bridge  # noqa: PLC0415 — deferred to avoid circular import
