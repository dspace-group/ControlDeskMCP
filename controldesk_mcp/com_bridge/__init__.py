...
Usage:
    from controldesk_mcp.com_bridge import startup, shutdown, dispatch, get_connection, domains
...
from controldesk_mcp.com_bridge import sta_thread as _sta
from controldesk_mcp.com_bridge.connection import ComConnection, ConnectionState
from controldesk_mcp.com_bridge.detector import is_version_installed, normalize_user_version
