    ...
    return [
        {
            ...
            "content": (
                ...
                f"2. Call `controldesk_app_start_or_attach`{version_arg} to launch or attach to ControlDesk. "
                ...
                f"   bridge state.\n"
                f"4. If a project path was provided: call `controldesk_project_open`{project_arg} and confirm "
                f"   the project opened successfully.\n"
                f"5. If a platform was specified: call `controldesk_platform_connect`{platform_arg}, then "
                f"   call `controldesk_platform_query` with action='get_connection_state' to verify.\n"
    ...
    return [
        {
            ...
            "content": (
                ...
                f"4. If state is NOT_STARTED or DISCONNECTED: call `controldesk_app_start_or_attach` "
                f"   and repeat step 2.\n"
                ...
                f"   then calling `controldesk_app_start_or_attach` again.\n"
                f"6. Call `controldesk_platform_query` with action='list' to see registered platforms; call "
                f"   it with action='get_connection_state' for each platform.\n"
