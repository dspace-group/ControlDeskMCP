    ...
    return [
        {
            ...
            "content": (
                ...
                f"3. Call `controldesk_recorder_config_manage` with action='configure'{file_arg} "
                f"   to set the output file, "
                ...
                f"7. During recording, call `controldesk_recorder_main_manage` with "
                f"   action='pause' or action='resume'.\n"
