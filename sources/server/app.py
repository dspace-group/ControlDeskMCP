...
from sources.server.server import MCPServer
...
async def _lifespan(server: FastMCP) -> Any:  # type: ignore[type-arg]
    ...
    from sources import com_bridge  # noqa: PLC0415
...
# To add a new domain, add its import to sources/server/registry.py only.
