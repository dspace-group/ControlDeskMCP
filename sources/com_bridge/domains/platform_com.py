...
# Keys MUST match OnlineCalibrationBehavior enum values in sources/models/platform.py
...
# Keys MUST match InitialPageType enum values in sources/models/platform.py
