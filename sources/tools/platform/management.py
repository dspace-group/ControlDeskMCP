...
All orchestration is delegated to sources.services.platform_service.
"""
...
from sources.services import platform_service
...
async def platform_manage(
    ...
    if action == PlatformManageAction.configure_calibration_behavior:
        ...
        from sources.models.platform import OnlineCalibrationBehavior
