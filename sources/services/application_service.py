...
from sources.com_bridge.errors import BridgeError, BridgeNotInstalledError
...
async def dry_run_start_or_attach(
    ...
    from sources.services import project_service
    ...
    try:
        ...
        if not version_switch_required:
            message = (
                ...
                if running_version
                else "No ControlDesk instance is currently running — start_controldesk would launch or attach without quitting anything."
            )
