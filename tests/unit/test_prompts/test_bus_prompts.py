"""Unit tests for sources.prompts.bus_prompts."""
...
class TestConfigureBusLogging:
    def test_returns_one_user_message(self) -> None:
        from sources.prompts.bus_prompts import configure_bus_logging
...
class TestRunBusMonitor:
    def test_returns_one_user_message(self) -> None:
        from sources.prompts.bus_prompts import run_bus_monitor
...
class TestReplayBusData:
    def test_returns_one_user_message(self) -> None:
        from sources.prompts.bus_prompts import replay_bus_data
...
class TestManageBusFilters:
    def test_returns_one_user_message(self) -> None:
        from sources.prompts.bus_prompts import manage_bus_filters
