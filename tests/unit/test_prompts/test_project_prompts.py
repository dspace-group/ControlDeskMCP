"""Unit tests for controldesk_mcp.prompts.project_prompts."""
...
class TestManageProjectWorkflow:
    def test_returns_one_user_message(self) -> None:
        from controldesk_mcp.prompts.project_prompts import manage_project_workflow
...
class TestExportExperiment:
    def test_returns_one_user_message(self) -> None:
        from controldesk_mcp.prompts.project_prompts import export_experiment
...
class TestManageProjectRoots:
    def test_returns_one_user_message(self) -> None:
        from controldesk_mcp.prompts.project_prompts import manage_project_roots
...
class TestManageExperiments:
    def test_returns_one_user_message(self) -> None:
        from controldesk_mcp.prompts.project_prompts import manage_experiments
