"""Unit tests for sources.prompts.calibration_prompts."""
...
class TestRunCalibrationWorkflow:
    def test_returns_one_user_message(self) -> None:
        from sources.prompts.calibration_prompts import run_calibration_workflow
...
class TestProposedCalibrationFlow:
    def test_returns_one_user_message(self) -> None:
        from sources.prompts.calibration_prompts import proposed_calibration_flow
...
class TestManageCalibrationDataSets:
    def test_returns_one_user_message(self) -> None:
        from sources.prompts.calibration_prompts import manage_calibration_data_sets
